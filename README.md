...
A 3D globe with upcoming BIM events around the world.
...
- Interactive 3D globe you can spin and click through to explore events
- Table view with search and filtering by format (in-person, online, hybrid)
- Download calendar files to save events
- Share direct links to specific events
- Available in 6 languages: English, Spanish, French, German, Italian, and Dutch
...
MIT with an attribution requirement -- footer credits must remain visible. See [license.md](license.md) for details.

Built by [Nonica.io](https://nonica.io)
